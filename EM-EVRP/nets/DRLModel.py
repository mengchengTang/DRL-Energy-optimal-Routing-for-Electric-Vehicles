...
class AttentionModel(nn.Module):
    ...
    def _inner(self, information, distances, slopes, embeddings):
        """
        :param information: [batch_size, sequences_size, dim=6]
        :param distances:   [batch_size, sequences_size, sequences_size]
        :param slopes:   [batch_size, sequences_size, sequences_size]
        :param embeddings:  [batch_size, sequences_size, embedding_dim]
        ...
        now_idx = torch.zeros(batch_size, device=device, dtype=torch.int64)
