...
parser.add_argument('--CVRP_lib_test', action='store_true', default=False)   # 在标准算例上进行测试
parser.add_argument('--depot_charging', action='store_true', default=True)   # 在标准算例上进行测试
parser.add_argument('--plot_num', default=0, type=int, help="测试画图的张数")
...
parser.add_argument("--obj",default="ME-EVRP",help="ME-EVRP, MD-EVRP")
...
# args.checkpoint = os.path.join('evrp', '100', "DL", "ME-AM-best.pt")
args.checkpoint = os.path.join('evrp', '20', "rollout", "C20_14_01_21.442851",  "best.pt")
