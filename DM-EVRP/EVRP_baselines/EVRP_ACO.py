...
class EVRP():
    def __init__(self, i, instance, t_limit, Start_SOC, velocity, max_load, alpha, beta, rho, epochs, ant_number, plot_num):
        ...
        num_dict = {15: 10, 25: 20, 59: 50, 109: 100, 23: 18, 26: 21, 27: 22, 44: 39, 49: 44, 84: 75}  # 每一个问题规模对应的客户人数
...
if __name__ == '__main__':
    ...
    parser.add_argument('--CVRP_lib_test', default=True)
    ...
    parser.add_argument('--epoch', default=1000, type=int, help='epoch of iteration 10:400 20:600 50:800 100:1000')
